...
function geometry(params) {
    ...
    // 处理数据
    var ds = utils_2.transformData(xField, yField, data);
    // 再次处理数据，通过 type 字段分成左右数据
    var groupData = Object.values(util_1.groupBy(ds, 'type'));
    chart.scale({
        type: {
            sync: true,
        },
    ...
    firstView.data(util_1.get(groupData, [0], []));
    ...
    secondView.data(util_1.get(groupData, [1], []));
...
function meta(params) {
    ...
    common_1.scale((_a = {},
        ...
        _a))(utils_1.deepAssign({}, params, { chart: firstView }));
    common_1.scale((_b = {},
        _b[xField] = xAxis,
        _b[yField[1]] = yAxis[yField[1]],
        _b))(utils_1.deepAssign({}, params, { chart: secondView }));
    return params;
}
/**
 * axis 配置
